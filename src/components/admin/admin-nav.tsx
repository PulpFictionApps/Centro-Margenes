        ...
        >
          {navItems.map((item) => (
            <Link
              ...
              href={item.href}
              className={cn(
                "flex flex-1 min-h-[5rem] flex-col items-center justify-center gap-1 px-1 py-6 transition-colors",
          ...
          <Link
            href="/dashboard"
            className="flex flex-1 min-h-[5rem] flex-col items-center justify-center gap-1 px-1 py-6 text-neutral-400 transition-colors hover:text-brand"
          >
            <ArrowLeft className="h-8 w-8 flex-shrink-0" />
